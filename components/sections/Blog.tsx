...
export function Blog() {
  return (
    <section id="blog" className="py-4 md:py-6 lg:py-8 px-4 sm:px-6 md:px-12 lg:px-16 max-w-[1400px] mx-auto scroll-mt-24">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {blogPosts.map((post, idx) => (
          ...
          >
            <Link href={post.href} target="_blank" rel="noopener noreferrer" className="flex flex-col h-full">
              {/* Cover Image */}
              ...
              <div className="flex flex-col flex-grow p-6">
                ...
                <div className="mt-auto flex items-end justify-between gap-4">
                  ...
                  <span
                    className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-widest transition-colors flex-shrink-0 group-hover:text-emerald-500"

export function Footer() {
  return (
    <footer className="mt-8 border-t py-8 transition-colors duration-300" style={{ borderColor: 'var(--border)' }}>
      <div className="max-w-[1400px] mx-auto px-8 md:px-12 lg:px-16 flex flex-col md:flex-row justify-between items-center gap-4 text-[9px] font-mono tracking-tighter uppercase relative z-10" style={{ color: 'var(--text-muted)' }}>
        <p>LOCATION: INDIA</p>
